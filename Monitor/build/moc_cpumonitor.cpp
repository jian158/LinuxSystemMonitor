...
QT_MOC_LITERAL(3, 19, 6) // "render"

    },
    "CPUMonitor\0update\0\0render"
};
...
void CPUMonitor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CPUMonitor *_t = static_cast<CPUMonitor *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject CPUMonitor::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CPUMonitor.data,
      qt_meta_data_CPUMonitor,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CPUMonitor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CPUMonitor.stringdata0))
        return static_cast<void*>(const_cast< CPUMonitor*>(this));
